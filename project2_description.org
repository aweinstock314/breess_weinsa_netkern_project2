...
** DONE Modify tcp_parse_options to recognize the option in net/ipv4/tcp_input.c on SYN/SYNACK
...
CLOSED: [2017-12-08 Fri 15:00]
** TODO Research where to go from here; this probably involves modifying low-level TCP send/recv stuff.
